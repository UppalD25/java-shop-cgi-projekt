...
public class AccountDAO implements IAccount {
    ...
    public void updateAccount(Account account) {
        ...
        try (Connection conn = Connector.getConnectionToMySQL();
            ...
            DatabaseQueryHelper.updateAccountPreparingStatment(account, stmt);
    ...
    /**
     * Hard Delete - Löscht Account wirklich aus DB (nur für Admin/Tests)
     */
    public void hardDeleteAccount(int accountId) {
        ...
        try (Connection conn = Connector.getConnectionToMySQL();
            ...
            stmt.setInt(1, accountId);
            stmt.executeUpdate();
            System.out.println("Account " + accountId + " wurde permanent gelöscht (Hard Delete)");

        } catch (SQLException e) {
            System.err.println("Fehler beim permanenten Löschen des Accounts mit der ID: " + accountId);
            e.printStackTrace();
        }
    }
